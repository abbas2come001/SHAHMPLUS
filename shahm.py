...
async def join_channel(event):
    ...
    try:
        ...
        await shahm1(JoinChannelRequest("@SH_AH_M"))
...
مثال : اذا كنت تريد التجميع في بوت المليار
تكتب الامر بهذا الشكل /so @zmmbot 300
╍╍╍╍╍╍╍╍╍╍╍╍╍╍╍╍╍╍╍╍╍╍╍╍
