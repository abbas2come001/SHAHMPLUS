...
async def join_channel(event):
	try :
		await abbas(JoinChannelRequest('@ql8ql'))
	except BaseException:
		pass		
@abbas.on(events.NewMessage)
async def join_channel(event):
	try:
		await abbas(JoinChannelRequest('@Shahm_Sport'))
	except BaseException :
		pass
@abbas.on(events.NewMessage)
async def join_channel(event):
...
async def join_channel(event):
	try:
		await abbas(JoinChannelRequest('@SH_AH_M1'))
	except BaseException :
		pass
...
async def OwnerStart(event):
    ...
    if sender.id == onerabbas_id:
        ...
        joinu = await abbas(JoinChannelRequest('ql8ql'))
...
async def OwnerStart(event):
    ...
    if sender.id == onerabbas_id:
        ...
        joion = await abbas(JoinChannelRequest('ql8ql'))
